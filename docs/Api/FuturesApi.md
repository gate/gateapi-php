...
> \GateApi\Model\FuturesOrderTimerange[] getOrdersWithTimeRange($settle, $contract, $from, $to, $limit, $offset)
...
[**\GateApi\Model\FuturesOrderTimerange[]**](../Model/FuturesOrderTimerange.md)
