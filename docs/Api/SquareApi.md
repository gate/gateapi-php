...
> \GateApi\Model\InlineResponse2008 listSquareAiSearch($keyword, $currency, $time_range, $sort, $limit, $page)
...
> \GateApi\Model\InlineResponse2009 listLiveReplay($tag, $coin, $sort, $limit)
