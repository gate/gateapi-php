...
**limit_price** | **string** | Limit price. If omitted, the market price is used | [optional] 
**trigger_price** | **string** | Trigger price. If omitted, the order is triggered immediately | [optional] 
