...
**min_amount** | **string** | Minimum limit | [optional] 
**max_amount** | **string** | Maximum limit | [optional] 
...
**pay_type_json** | **string** | Payment method list | [optional] 
...
**new_hand** | **string** | Merchant-friendly order | [optional] 
