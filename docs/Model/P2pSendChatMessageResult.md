...
**conversation_id** | **string** | Chat ID, formatted as both parties&#39; UIDs concatenated in ascending order | [optional] 
...
**toast_msg** | **string** | Risk control prompt message; returned only when risk_type&#x3D;1 | [optional] 
