...
**activation_price** | **string** | Activation price, 0 means trigger immediately | [optional] [default to '0']
...
**pos_margin_mode** | **string** | Position margin mode: isolated/cross | [optional] 
**position_mode** | **string** | Position mode: single, dual, and dual_plus | [optional] 
