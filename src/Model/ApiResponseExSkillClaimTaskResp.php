...
/**
 * ApiResponseExSkillClaimTaskResp Class Doc Comment
 *
 * @category Class
 * @description Receive task response
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class ApiResponseExSkillClaimTaskResp implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiResponse_ExSkillClaimTaskResp';
