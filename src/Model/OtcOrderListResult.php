...
/**
 * OtcOrderListResult Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class OtcOrderListResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OtcOrderListResult';
    ...
    protected static $openAPITypes = [
        ...
        'total_pn' => 'int',
        'count' => 'int',
        'list' => '\GateApi\Model\OtcOrderListItem[]'
    ];
     ...
     * Gets list
     *
     * @return \GateApi\Model\OtcOrderListItem[]
     */
     ...
     * Sets list
     *
     * @param \GateApi\Model\OtcOrderListItem[] $list list
     *
     * @return $this
     */
