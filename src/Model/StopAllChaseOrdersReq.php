...
/**
 * StopAllChaseOrdersReq Class Doc Comment
 *
 * @category Class
 * @description Request body for stopping chase orders in batch
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class StopAllChaseOrdersReq implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StopAllChaseOrdersReq';
     ...
     * Sets contract
     *
     * @param string|null $contract Optional contract name
     *
     * @return $this
     */
     ...
     *
     * @param string|null $pos_margin_mode Optional margin mode
     *
     * @return $this
     */
