...
/**
 * Symbols2Data Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class Symbols2Data implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Symbols_2_data';
    ...
    protected static $openAPITypes = [
        'total' => 'int',
        'total_page' => 'int',
        'list' => '\GateApi\Model\SymbolListItem[]'
    ];
     ...
     * Gets list
     *
     * @return \GateApi\Model\SymbolListItem[]|null
     */
     ...
     * Sets list
     *
     * @param \GateApi\Model\SymbolListItem[]|null $list Symbol list
     *
     * @return $this
     */
