...
/**
 * GetCounterpartyUserInfoRequest Class Doc Comment
 *
 * @category Class
 * @description Get counterparty user info request
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class GetCounterpartyUserInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCounterpartyUserInfoRequest';
