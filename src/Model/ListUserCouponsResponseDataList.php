...
/**
 * ListUserCouponsResponseDataList Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class ListUserCouponsResponseDataList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListUserCouponsResponse_data_list';
     ...
     * Sets id
     *
     * @param int|null $id Coupon distribution record ID (coupon_send_issuing_log.id), used as `last_id` for cursor-based pagination
     *
     * @return $this
     */
     ...
     * Sets details_id
     *
     * @param int|null $details_id User coupon detail table primary key (separate table per type). This field is 0 for task coupons, has value for regular coupons
     *
     * @return $this
     */
     ...
     * Sets coupon_type
     *
     * @param string|null $coupon_type Coupon type, enum values same as the `type` parameter
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param string|null $amount Coupon denomination (formatted string with thousand separators). Meaning by type: point card = balance, interest rate boost coupon = interest rate percentage (e.g., '5%'), VIP trial card = VIP level number, position voucher = face value × leverage, others = face value
     *
     * @return $this
     */
     ...
     * Sets rule_new
     *
     * @param string|null $rule_new Coupon usage rule text. List endpoint always returns empty string \"\", only detail endpoint returns actual value
     *
     * @return $this
     */
     ...
     * Sets expire_time
     *
     * @param int|null $expire_time Expiration time (Unix timestamp). Some types replace this with actual expiration time after activation or use (e.g., contract_bonus uses expired_timest after activation). Point card type returns 0
     *
     * @return $this
     */
     ...
     *
     * @param int|null $expire_time_order_by Sorting expiration time (from the original expiration time of the distribution record, unaffected by activation). Used as the `expire_time` parameter for the next request in cursor-based pagination
     *
     * @return $this
     */
     ...
     * Sets expire_second
     *
     * @param int|null $expire_second Seconds remaining until expiration. Returns 0 for expired or Point Card types
     *
     * @return $this
     */
     ...
     * Sets task_title
     *
     * @param string|null $task_title Task title (only task coupons have value, regular coupons return empty string \"\")
     *
     * @return $this
     */
     ...
     * Sets task_desc
     *
     * @param string|null $task_desc Task description (only task coupons have value, regular coupons return empty string \"\")
     *
     * @return $this
     */
     ...
     * Sets task_start_at
     *
     * @param int|null $task_start_at Task start timestamp (Unix). Only has value for task coupons in TASK_EXPIRED status, otherwise 0
     *
     * @return $this
     */
     ...
     * Sets task_expire_at
     *
     * @param int|null $task_expire_at Task expiration timestamp (Unix). Currently fixed at 0, reserved field
     *
     * @return $this
     */
     ...
     *
     * @param int|null $task_completed_at Task completion timestamp (Unix). Currently fixed at 0, reserved field
     *
     * @return $this
     */
     ...
     * Sets extra
     *
     * @param object[]|null $extra Extension fields. List endpoint always returns empty array [], only the detail endpoint has values
     *
     * @return $this
     */
