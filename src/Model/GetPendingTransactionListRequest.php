...
/**
 * GetPendingTransactionListRequest Class Doc Comment
 *
 * @category Class
 * @description Get pending transaction list request
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class GetPendingTransactionListRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPendingTransactionListRequest';
