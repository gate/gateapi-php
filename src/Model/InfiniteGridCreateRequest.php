...
/**
 * InfiniteGridCreateRequest Class Doc Comment
 *
 * @category Class
 * @description Create the request body for the infinite grid policy.
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class InfiniteGridCreateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InfiniteGridCreateRequest';
    ...
    protected static $openAPITypes = [
        ...
        'market' => 'string',
        'create_params' => '\GateApi\Model\InfiniteGridCreateParams'
    ];
    ...
    const STRATEGY_TYPE_INFINITE_GRID = 'infinite_grid';
    ...
    {
        return [
            self::STRATEGY_TYPE_INFINITE_GRID,
        ];
    }
     ...
     * Gets create_params
     *
     * @return \GateApi\Model\InfiniteGridCreateParams
     */
     ...
     * Sets create_params
     *
     * @param \GateApi\Model\InfiniteGridCreateParams $create_params create_params
     *
     * @return $this
     */
