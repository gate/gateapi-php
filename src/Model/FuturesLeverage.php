...
/**
 * FuturesLeverage Class Doc Comment
 *
 * @category Class
 * @description Return result includes Lever field
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class FuturesLeverage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FuturesLeverage';
