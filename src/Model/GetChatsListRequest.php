...
/**
 * GetChatsListRequest Class Doc Comment
 *
 * @category Class
 * @description Get chat history request
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class GetChatsListRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetChatsListRequest';
