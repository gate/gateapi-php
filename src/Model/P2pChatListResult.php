...
/**
 * P2pChatListResult Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class P2pChatListResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'P2pChatListResult';
    ...
    protected static $openAPITypes = [
        'messages' => '\GateApi\Model\P2pChatMessage[]',
        'memo' => 'string',
        'has_history' => 'bool',
        'txid' => 'int',
        'srvtm' => 'int',
     ...
     * Gets messages
     *
     * @return \GateApi\Model\P2pChatMessage[]|null
     */
     ...
     * Sets messages
     *
     * @param \GateApi\Model\P2pChatMessage[]|null $messages Message List
     *
     * @return $this
     */
