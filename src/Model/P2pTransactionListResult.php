...
/**
 * P2pTransactionListResult Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class P2pTransactionListResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'P2pTransactionListResult';
    ...
    protected static $openAPITypes = [
        'list' => '\GateApi\Model\P2pTransactionListItem[]',
        'trans_time' => '\GateApi\Model\P2pTransactionTimeMarker[]',
        'count' => 'int',
        'exported_num' => 'int'
    ];
     ...
     * Gets list
     *
     * @return \GateApi\Model\P2pTransactionListItem[]|null
     */
     ...
     * Sets list
     *
     * @param \GateApi\Model\P2pTransactionListItem[]|null $list list
     *
     * @return $this
     */
     ...
     * Gets trans_time
     *
     * @return \GateApi\Model\P2pTransactionTimeMarker[]|null
     */
     ...
     * Sets trans_time
     *
     * @param \GateApi\Model\P2pTransactionTimeMarker[]|null $trans_time Countdown time
     *
     * @return $this
     */
