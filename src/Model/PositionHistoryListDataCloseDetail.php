...
/**
 * PositionHistoryListDataCloseDetail Class Doc Comment
 *
 * @category Class
 * @description Liquidation details (null for normal close)
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class PositionHistoryListDataCloseDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PositionHistoryList_data_close_detail';
     ...
     * Sets margin_level
     *
     * @param string|null $margin_level Margin ratio (multiplied by 100)
     *
     * @return $this
     */
     ...
     * Sets equity
     *
     * @param string|null $equity Net equity
     *
     * @return $this
     */
     ...
     * Sets stop_out_level
     *
     * @param string|null $stop_out_level Liquidation ratio (multiplied by 100)
     *
     * @return $this
     */
