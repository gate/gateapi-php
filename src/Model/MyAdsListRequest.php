...
/**
 * MyAdsListRequest Class Doc Comment
 *
 * @category Class
 * @description Get my ads list request
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class MyAdsListRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MyAdsListRequest';
