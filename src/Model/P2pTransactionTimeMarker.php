...
/**
 * P2pTransactionTimeMarker Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class P2pTransactionTimeMarker implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'P2pTransactionTimeMarker';
