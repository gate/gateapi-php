...
/**
 * PlaceBizPushOrder Class Doc Comment
 *
 * @category Class
 * @description Place ad order request
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class PlaceBizPushOrder implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlaceBizPushOrder';
