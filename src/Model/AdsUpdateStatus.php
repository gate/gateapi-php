...
/**
 * AdsUpdateStatus Class Doc Comment
 *
 * @category Class
 * @description Ad status update request
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class AdsUpdateStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdsUpdateStatus';
