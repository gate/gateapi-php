...
class Position implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $maintenance_rate The maintenance margin requirement for the risk limit at which the current position size is located.Since the maintenance margin for the position has been calculated using a tiered system, the actual maintenance margin rate required for this position is based on `average_maintenance_rate`.
     *
     * @return $this
     */
     ...
     * Sets liq_price
     *
     * @param string|null $liq_price Estimated liquidation price, for reference only. The actual liquidation trigger is based on the position mmr or the account maintenance margin level.
     *
     * @return $this
     */
     ...
     * Sets initial_margin
     *
     * @param string|null $initial_margin Initial margin of postions
     *
     * @return $this
     */
     ...
     *
     * @param string|null $maintenance_margin Maintencance margin of postions
     *
     * @return $this
     */
     ...
     * Sets realised_pnl
     *
     * @param string|null $realised_pnl Realised PnL, the sum of all cash flows generated by this position, including settlement of closing positions, settlement of funding fees, and transaction fee expenses.
     *
     * @return $this
     */
     ...
     * Sets pnl_pnl
     *
     * @param string|null $pnl_pnl settled pnl when closing postion
     *
     * @return $this
     */
     ...
     * Sets pnl_fund
     *
     * @param string|null $pnl_fund funding fees
     *
     * @return $this
     */
     ...
     * Sets pnl_fee
     *
     * @param string|null $pnl_fee trading fees
     *
     * @return $this
     */
