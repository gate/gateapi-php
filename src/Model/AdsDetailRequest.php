...
/**
 * AdsDetailRequest Class Doc Comment
 *
 * @category Class
 * @description Get ad details request
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class AdsDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdsDetailRequest';
