...
/**
 * AutoInvestPlanListInfoResp Class Doc Comment
 *
 * @category Class
 * @description Auto invest planListPaginatedResponse
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class AutoInvestPlanListInfoResp implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AutoInvestPlanListInfoResp';
    ...
    protected static $openAPITypes = [
        ...
        'page_count' => 'int',
        'total_count' => 'int',
        'list' => '\GateApi\Model\AutoInvestPlanDetail[]'
    ];
     ...
     * Sets list
     *
     * @param \GateApi\Model\AutoInvestPlanDetail[] $list PlanList
     *
     * @return $this
     */
