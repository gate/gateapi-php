 ...
 *
 * @category Class
 * @description 现货马丁策略的创建参数。
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class SpotMartingaleCreateParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpotMartingaleCreateParams';
    ...
    public function setMaxOrders($max_orders)
    {
        ...
        if (($max_orders < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_orders when calling SpotMartingaleCreateParams., must be bigger than or equal to 1.');
        }
