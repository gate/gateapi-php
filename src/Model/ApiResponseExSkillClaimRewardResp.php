 ...
 * @link     https://www.gate.com
 */
class ApiResponseExSkillClaimRewardResp implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiResponse_ExSkillClaimRewardResp';
    ...
    protected static $openAPITypes = [
        ...
        'label' => 'string',
        'message' => 'string',
        'data' => '\GateApi\Model\ApiResponseExSkillClaimRewardRespData',
        'timestamp' => 'int'
    ];
     ...
     * Gets data
     *
     * @return \GateApi\Model\ApiResponseExSkillClaimRewardRespData|null
     */
     ...
     * Sets data
     *
     * @param \GateApi\Model\ApiResponseExSkillClaimRewardRespData|null $data data
     *
     * @return $this
     */
