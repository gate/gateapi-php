...
class OrderResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets side
     *
     * @param string|null $side Buy or sell orders - buy - sell
     *
     * @return $this
     */
     ...
     * Sets usdt_amount
     *
     * @param string|null $usdt_amount Amount (USDT)
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Token
     *
     * @return $this
     */
     ...
     *
     * @param string|null $currency_amount Token amount
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param int|null $status Order Status - `0` : All - `1` : Processing - `2` : Successful - `3` : Failed - `4` : Cancelled - `5` : Buy order placed but transfer not completed - `6` : Order cancelled but transfer not completed
     *
     * @return $this
     */
     ...
     * Sets chain
     *
     * @param string|null $chain Blockchain
     *
     * @return $this
     */
     ...
     * Sets gas_fee
     *
     * @param string|null $gas_fee Gas Fee (USDT-based)
     *
     * @return $this
     */
     ...
     * Sets failed_reason
     *
     * @param string|null $failed_reason Failure reason (if applicable)
     *
     * @return $this
     */
     ...
     * Sets create_time
     *
     * @param int|null $create_time Creation timestamp
     *
     * @return $this
     */
