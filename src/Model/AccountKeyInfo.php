...
class AccountKeyInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets state
     *
     * @param int|null $state API Key Status: 1 - Normal, 2 - Locked, 3 - Frozen (can only be modified; default is 1 upon creation)
     *
     * @return $this
     */
     ...
     * Sets mode
     *
     * @param int|null $mode User Mode: 1 - Classic, 2 - Legacy Unified (can only be specified during creation, non-modifiable afterwards)
     *
     * @return $this
     */
