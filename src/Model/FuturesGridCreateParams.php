 ...
 * @link     https://www.gate.com
 */
class FuturesGridCreateParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FuturesGridCreateParams';
    ...
    public function setGridNum($grid_num)
    {
        ...
        if (($grid_num < 1)) {
            throw new \InvalidArgumentException('invalid value for $grid_num when calling FuturesGridCreateParams., must be bigger than or equal to 1.');
        }
