...
/**
 * SpotOrderStopLoss Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://www.gate.com
 */
class SpotOrderStopLoss implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpotOrderStopLoss';
     ...
     * Sets trigger_price
     *
     * @param string|null $trigger_price Stop loss trigger price When `side == \"buy\"`, `trigger_price` must be less than `price` When `side == \"sell\"`, `trigger_price` must be greater than `price`
     *
     * @return $this
     */
     ...
     * Sets order_price
     *
     * @param string|null $order_price Stop-loss order price
     *
     * @return $this
     */
