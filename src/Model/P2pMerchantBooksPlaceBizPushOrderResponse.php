...
/**
 * P2pMerchantBooksPlaceBizPushOrderResponse Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class P2pMerchantBooksPlaceBizPushOrderResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'P2pMerchantBooksPlaceBizPushOrderResponse';
