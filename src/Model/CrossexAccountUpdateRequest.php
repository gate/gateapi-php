...
class CrossexAccountUpdateRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets exchange_type
     *
     * @param string|null $exchange_type Exchange (`BINANCE` / `OKX` / `GATE` / `BYBIT` / `KRAKEN` / `HYPERLIQUID` / `DERIBIT` / `LIGHTER` / `CROSSEX`). When account mode is `ISOLATED_EXCHANGE`, the exchange must be specified to adjust futures position mode.
     *
     * @return $this
     */
