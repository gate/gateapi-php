...
/**
 * UploadChatFile Class Doc Comment
 *
 * @category Class
 * @description Upload chat file request
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class UploadChatFile implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UploadChatFile';
