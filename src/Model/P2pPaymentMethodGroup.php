...
/**
 * P2pPaymentMethodGroup Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class P2pPaymentMethodGroup implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'P2pPaymentMethodGroup';
    ...
    protected static $openAPITypes = [
        ...
        'pay_name' => 'string',
        'ids' => 'int[]',
        'list' => '\GateApi\Model\P2pPaymentMethodAccount[]'
    ];
     ...
     * Gets list
     *
     * @return \GateApi\Model\P2pPaymentMethodAccount[]|null
     */
     ...
     * Sets list
     *
     * @param \GateApi\Model\P2pPaymentMethodAccount[]|null $list list
     *
     * @return $this
     */
