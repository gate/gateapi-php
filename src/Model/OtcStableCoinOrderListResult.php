...
/**
 * OtcStableCoinOrderListResult Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class OtcStableCoinOrderListResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OtcStableCoinOrderListResult';
    ...
    protected static $openAPITypes = [
        ...
        'page_number' => 'int',
        'total_page' => 'int',
        'list' => '\GateApi\Model\OtcStableCoinOrderListItem[]'
    ];
     ...
     * Gets list
     *
     * @return \GateApi\Model\OtcStableCoinOrderListItem[]
     */
     ...
     * Sets list
     *
     * @param \GateApi\Model\OtcStableCoinOrderListItem[] $list list
     *
     * @return $this
     */
