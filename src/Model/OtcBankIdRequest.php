...
/**
 * OtcBankIdRequest Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class OtcBankIdRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OtcBankIdRequest';
     ...
     * Sets bank_id
     *
     * @param string $bank_id Bank card ID
     *
     * @return $this
     */
