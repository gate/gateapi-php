...
/**
 * SpotOrderStopProfit Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://www.gate.com
 */
class SpotOrderStopProfit implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpotOrderStopProfit';
     ...
     * Sets trigger_price
     *
     * @param string|null $trigger_price Take profit trigger price When `side == \"buy\"`, `trigger_price` must be greater than `price` When `side == \"sell\"`, `trigger_price` must be less than `price`
     *
     * @return $this
     */
     ...
     * Sets order_price
     *
     * @param string|null $order_price Take profit order price
     *
     * @return $this
     */
