...
/**
 * AdsListRequest Class Doc Comment
 *
 * @category Class
 * @description Get market ads list request
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class AdsListRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdsListRequest';
