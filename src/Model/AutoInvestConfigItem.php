...
/**
 * AutoInvestConfigItem Class Doc Comment
 *
 * @category Class
 * @description Investment currency configuration item
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class AutoInvestConfigItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AutoInvestConfigItem';
     ...
     * Sets max_limit
     *
     * @param string $max_limit InvestmentLimit
     *
     * @return $this
     */
