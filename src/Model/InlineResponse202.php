...
class InlineResponse202 implements ModelInterface, ArrayAccess
{
     ...
     * Sets exchange_type
     *
     * @param string|null $exchange_type Requested exchange to modify (BINANCE/OKX/GATE/CROSSEX; when account mode is ISOLATED_EXCHANGE, the exchange must be specified to modify futures position mode)
     *
     * @return $this
     */
