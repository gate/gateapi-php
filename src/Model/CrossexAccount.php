...
/**
 * CrossexAccount Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class CrossexAccount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CrossexAccount';
    ...
    protected static $openAPITypes = [
        ...
        'assets' => '\GateApi\Model\CrossexAccountAsset[]'
    ];
     ...
     * Gets assets
     *
     * @return \GateApi\Model\CrossexAccountAsset[]
     */
     ...
     * Sets assets
     *
     * @param \GateApi\Model\CrossexAccountAsset[] $assets Asset list: grouped by exchange and currency, returning per-account balances, margin, and PnL details
     *
     * @return $this
     */
