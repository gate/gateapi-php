...
/**
 * LaunchPoolV4ErrorResponse Class Doc Comment
 *
 * @category Class
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class LaunchPoolV4ErrorResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LaunchPoolV4ErrorResponse';
    ...
    const LABEL_PROJECT_NOT_FOUND = 'PROJECT_NOT_FOUND';
