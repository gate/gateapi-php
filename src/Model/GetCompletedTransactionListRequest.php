...
/**
 * GetCompletedTransactionListRequest Class Doc Comment
 *
 * @category Class
 * @description Get completed/historical transaction list request
 * @package  GateApi
 * @author   Gate
 * @link     https://www.gate.com
 */
class GetCompletedTransactionListRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCompletedTransactionListRequest';
