...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/7.2.128/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: v4.106.128' . PHP_EOL;
        $report .= '    SDK Package Version: 7.2.128' . PHP_EOL;
