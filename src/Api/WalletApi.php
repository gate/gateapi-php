...
class WalletApi
{
     ...
     *
     * @param  string $tx_id Transfer transaction ID (required)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\AccountTransferDetail
     */
    public function getTransfer($tx_id)
    {
        list($response) = $this->getTransferWithHttpInfo($tx_id);
        return $response;
    }
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\AccountTransferDetail, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransferWithHttpInfo($tx_id)
    {
        $request = $this->getTransferRequest($tx_id);
        ...
        $returnType = '\GateApi\Model\AccountTransferDetail';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTransferAsync($tx_id)
    {
        return $this->getTransferAsyncWithHttpInfo($tx_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTransferAsyncWithHttpInfo($tx_id)
    {
        $returnType = '\GateApi\Model\AccountTransferDetail';
        $request = $this->getTransferRequest($tx_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTransferRequest($tx_id)
    {
        // verify the required parameter 'tx_id' is set
        if ($tx_id === null || (is_array($tx_id) && count($tx_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tx_id when calling getTransfer'
            );
        }
    ...
    /**
     * Operation getLowCapExchangeList
     *
     ...
     * @return string[]
     */
    public function getLowCapExchangeList()
    {
        list($response) = $this->getLowCapExchangeListWithHttpInfo();
        return $response;
    }

    /**
     * Operation getLowCapExchangeListWithHttpInfo
     *
     * Retrieve the list of low-liquidity or low-cap tokens
     *
     *
     ...
     */
    public function getLowCapExchangeListWithHttpInfo()
    {
        $request = $this->getLowCapExchangeListRequest();
    ...
    /**
     * Operation getLowCapExchangeListAsync
     *
     * Retrieve the list of low-liquidity or low-cap tokens
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLowCapExchangeListAsync()
    {
        return $this->getLowCapExchangeListAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getLowCapExchangeListAsyncWithHttpInfo
     *
     * Retrieve the list of low-liquidity or low-cap tokens
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLowCapExchangeListAsyncWithHttpInfo()
    {
        $returnType = 'string[]';
        $request = $this->getLowCapExchangeListRequest();
    ...
    /**
     * Create request for operation 'getLowCapExchangeList'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getLowCapExchangeListRequest()
    {

        $resourcePath = '/wallet/getLowCapExchangeList';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
