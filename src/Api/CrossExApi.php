...
class CrossExApi
{
    ...
    protected function listCrossexRuleSymbolsRequest($associative_array)
    {
        ...
        $resourcePath = '/crossex/rule/symbols';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexRiskLimit[]
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexRiskLimit[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listCrossexRuleRiskLimitsWithHttpInfo($symbols)
    {
        ...
        $returnType = '\GateApi\Model\CrossexRiskLimit[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    protected function listCrossexRuleRiskLimitsRequest($symbols)
    {
        ...
        $resourcePath = '/crossex/rule/risk_limits';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexTransferCoin[]
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexTransferCoin[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listCrossexTransferCoinsWithHttpInfo($associative_array)
    {
        ...
        $returnType = '\GateApi\Model\CrossexTransferCoin[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    protected function listCrossexTransferCoinsRequest($associative_array)
    {
        ...
        $resourcePath = '/crossex/transfers/coin';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexTransferRecord[]
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexTransferRecord[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listCrossexTransfersWithHttpInfo($associative_array)
    {
        ...
        $returnType = '\GateApi\Model\CrossexTransferRecord[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
     ...
     * Fund Transfer
     *
     * @param  \GateApi\Model\CrossexTransferRequest $crossex_transfer_request crossex_transfer_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexTransferResponse
     */
    public function createCrossexTransfer($crossex_transfer_request = null)
    {
        list($response) = $this->createCrossexTransferWithHttpInfo($crossex_transfer_request);
        return $response;
    }
     ...
     * Fund Transfer
     *
     * @param  \GateApi\Model\CrossexTransferRequest $crossex_transfer_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexTransferResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCrossexTransferWithHttpInfo($crossex_transfer_request = null)
    {
        $request = $this->createCrossexTransferRequest($crossex_transfer_request);
        ...
        $returnType = '\GateApi\Model\CrossexTransferResponse';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCrossexTransferAsync($crossex_transfer_request = null)
    {
        return $this->createCrossexTransferAsyncWithHttpInfo($crossex_transfer_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCrossexTransferAsyncWithHttpInfo($crossex_transfer_request = null)
    {
        $returnType = '\GateApi\Model\CrossexTransferResponse';
        $request = $this->createCrossexTransferRequest($crossex_transfer_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createCrossexTransferRequest($crossex_transfer_request = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($crossex_transfer_request)) {
            $_tempBody = $crossex_transfer_request;
        }
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexOrderActionResponse
     */
    public function createCrossexOrder($crossex_order_request = null)
    {
        list($response) = $this->createCrossexOrderWithHttpInfo($crossex_order_request);
        return $response;
    }
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexOrderActionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCrossexOrderWithHttpInfo($crossex_order_request = null)
    {
        $request = $this->createCrossexOrderRequest($crossex_order_request);
        ...
        $returnType = '\GateApi\Model\CrossexOrderActionResponse';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCrossexOrderAsync($crossex_order_request = null)
    {
        return $this->createCrossexOrderAsyncWithHttpInfo($crossex_order_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCrossexOrderAsyncWithHttpInfo($crossex_order_request = null)
    {
        $returnType = '\GateApi\Model\CrossexOrderActionResponse';
        $request = $this->createCrossexOrderRequest($crossex_order_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createCrossexOrderRequest($crossex_order_request = null)
    {
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexOrder
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexOrder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCrossexOrderWithHttpInfo($order_id)
    {
        ...
        $returnType = '\GateApi\Model\CrossexOrder';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    protected function getCrossexOrderRequest($order_id)
    {
        ...
        $resourcePath = '/crossex/orders/{order_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \GateApi\Model\CrossexOrderUpdateRequest $crossex_order_update_request crossex_order_update_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexOrderActionResponse
     */
    public function updateCrossexOrder($order_id, $crossex_order_update_request = null)
    {
        list($response) = $this->updateCrossexOrderWithHttpInfo($order_id, $crossex_order_update_request);
        return $response;
    }
     ...
     *
     * @param  string $order_id Support Order ID or Text for Modify Order (required)
     * @param  \GateApi\Model\CrossexOrderUpdateRequest $crossex_order_update_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexOrderActionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCrossexOrderWithHttpInfo($order_id, $crossex_order_update_request = null)
    {
        $request = $this->updateCrossexOrderRequest($order_id, $crossex_order_update_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCrossexOrderAsync($order_id, $crossex_order_update_request = null)
    {
        return $this->updateCrossexOrderAsyncWithHttpInfo($order_id, $crossex_order_update_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCrossexOrderAsyncWithHttpInfo($order_id, $crossex_order_update_request = null)
    {
        $returnType = '\GateApi\Model\CrossexOrderActionResponse';
        $request = $this->updateCrossexOrderRequest($order_id, $crossex_order_update_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCrossexOrderRequest($order_id, $crossex_order_update_request = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // body params
        $_tempBody = null;
        if (isset($crossex_order_update_request)) {
            $_tempBody = $crossex_order_update_request;
        }
     ...
     * @return \GateApi\Model\CrossexOrderActionResponse
     */
    public function cancelCrossexOrder($order_id)
    {
        list($response) = $this->cancelCrossexOrderWithHttpInfo($order_id);
        return $response;
    }
     ...
     * @return array of \GateApi\Model\CrossexOrderActionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelCrossexOrderWithHttpInfo($order_id)
    {
        $request = $this->cancelCrossexOrderRequest($order_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelCrossexOrderAsync($order_id)
    {
        return $this->cancelCrossexOrderAsyncWithHttpInfo($order_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelCrossexOrderAsyncWithHttpInfo($order_id)
    {
        $returnType = '\GateApi\Model\CrossexOrderActionResponse';
        $request = $this->cancelCrossexOrderRequest($order_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function cancelCrossexOrderRequest($order_id)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * Flash Swap Inquiry
     *
     * @param  \GateApi\Model\CrossexConvertQuoteRequest $crossex_convert_quote_request crossex_convert_quote_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexConvertQuoteResponse
     */
    public function createCrossexConvertQuote($crossex_convert_quote_request = null)
    {
        list($response) = $this->createCrossexConvertQuoteWithHttpInfo($crossex_convert_quote_request);
        return $response;
    }
     ...
     * Flash Swap Inquiry
     *
     * @param  \GateApi\Model\CrossexConvertQuoteRequest $crossex_convert_quote_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexConvertQuoteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCrossexConvertQuoteWithHttpInfo($crossex_convert_quote_request = null)
    {
        $request = $this->createCrossexConvertQuoteRequest($crossex_convert_quote_request);
        ...
        $returnType = '\GateApi\Model\CrossexConvertQuoteResponse';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCrossexConvertQuoteAsync($crossex_convert_quote_request = null)
    {
        return $this->createCrossexConvertQuoteAsyncWithHttpInfo($crossex_convert_quote_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCrossexConvertQuoteAsyncWithHttpInfo($crossex_convert_quote_request = null)
    {
        $returnType = '\GateApi\Model\CrossexConvertQuoteResponse';
        $request = $this->createCrossexConvertQuoteRequest($crossex_convert_quote_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createCrossexConvertQuoteRequest($crossex_convert_quote_request = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($crossex_convert_quote_request)) {
            $_tempBody = $crossex_convert_quote_request;
        }
     ...
     *
     * @param  \GateApi\Model\CrossexConvertOrderRequest $crossex_convert_order_request crossex_convert_order_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->createCrossexConvertOrderWithHttpInfo($crossex_convert_order_request);
        return $response;
    }
     ...
     * Flash Swap Transaction
     *
     * @param  \GateApi\Model\CrossexConvertOrderRequest $crossex_convert_order_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCrossexConvertOrderAsync($crossex_convert_order_request = null)
    {
        return $this->createCrossexConvertOrderAsyncWithHttpInfo($crossex_convert_order_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createCrossexConvertOrderRequest($crossex_convert_order_request = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($crossex_convert_order_request)) {
            $_tempBody = $crossex_convert_order_request;
        }
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexAccount
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexAccount, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCrossexAccountWithHttpInfo($associative_array)
    {
        ...
        $returnType = '\GateApi\Model\CrossexAccount';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
     ...
     *
     * @param  \GateApi\Model\CrossexAccountUpdateRequest $crossex_account_update_request crossex_account_update_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexAccountUpdateResponse
     */
    public function updateCrossexAccount($crossex_account_update_request = null)
    {
        list($response) = $this->updateCrossexAccountWithHttpInfo($crossex_account_update_request);
        return $response;
    }
     ...
     * Modify Account Contract Position Mode and Account Mode
     *
     * @param  \GateApi\Model\CrossexAccountUpdateRequest $crossex_account_update_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexAccountUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCrossexAccountWithHttpInfo($crossex_account_update_request = null)
    {
        $request = $this->updateCrossexAccountRequest($crossex_account_update_request);
        ...
        $returnType = '\GateApi\Model\CrossexAccountUpdateResponse';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCrossexAccountAsync($crossex_account_update_request = null)
    {
        return $this->updateCrossexAccountAsyncWithHttpInfo($crossex_account_update_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCrossexAccountAsyncWithHttpInfo($crossex_account_update_request = null)
    {
        $returnType = '\GateApi\Model\CrossexAccountUpdateResponse';
        $request = $this->updateCrossexAccountRequest($crossex_account_update_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCrossexAccountRequest($crossex_account_update_request = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($crossex_account_update_request)) {
            $_tempBody = $crossex_account_update_request;
        }
     ...
     *
     * @param  \GateApi\Model\CrossexLeverageRequest $crossex_leverage_request crossex_leverage_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexLeverageResponse
     */
    public function updateCrossexPositionsLeverage($crossex_leverage_request = null)
    {
        list($response) = $this->updateCrossexPositionsLeverageWithHttpInfo($crossex_leverage_request);
        return $response;
    }
     ...
     * Modify Contract Trading Pair Leverage Multiplier
     *
     * @param  \GateApi\Model\CrossexLeverageRequest $crossex_leverage_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexLeverageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCrossexPositionsLeverageWithHttpInfo($crossex_leverage_request = null)
    {
        $request = $this->updateCrossexPositionsLeverageRequest($crossex_leverage_request);
        ...
        $returnType = '\GateApi\Model\CrossexLeverageResponse';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCrossexPositionsLeverageAsync($crossex_leverage_request = null)
    {
        return $this->updateCrossexPositionsLeverageAsyncWithHttpInfo($crossex_leverage_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCrossexPositionsLeverageAsyncWithHttpInfo($crossex_leverage_request = null)
    {
        $returnType = '\GateApi\Model\CrossexLeverageResponse';
        $request = $this->updateCrossexPositionsLeverageRequest($crossex_leverage_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCrossexPositionsLeverageRequest($crossex_leverage_request = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($crossex_leverage_request)) {
            $_tempBody = $crossex_leverage_request;
        }
     ...
     * @return \GateApi\Model\CrossexLeverageResponse
     */
    public function updateCrossexMarginPositionsLeverage($crossex_leverage_request = null)
    {
        list($response) = $this->updateCrossexMarginPositionsLeverageWithHttpInfo($crossex_leverage_request);
        return $response;
    }
     ...
     * @return array of \GateApi\Model\CrossexLeverageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCrossexMarginPositionsLeverageWithHttpInfo($crossex_leverage_request = null)
    {
        $request = $this->updateCrossexMarginPositionsLeverageRequest($crossex_leverage_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCrossexMarginPositionsLeverageAsync($crossex_leverage_request = null)
    {
        return $this->updateCrossexMarginPositionsLeverageAsyncWithHttpInfo($crossex_leverage_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCrossexMarginPositionsLeverageAsyncWithHttpInfo($crossex_leverage_request = null)
    {
        $returnType = '\GateApi\Model\CrossexLeverageResponse';
        $request = $this->updateCrossexMarginPositionsLeverageRequest($crossex_leverage_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCrossexMarginPositionsLeverageRequest($crossex_leverage_request = null)
    {
     ...
     * Full Close Position
     *
     * @param  \GateApi\Model\CrossexClosePositionRequest $crossex_close_position_request crossex_close_position_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexOrderActionResponse
     */
    public function closeCrossexPosition($crossex_close_position_request = null)
    {
        list($response) = $this->closeCrossexPositionWithHttpInfo($crossex_close_position_request);
        return $response;
    }
     ...
     * Full Close Position
     *
     * @param  \GateApi\Model\CrossexClosePositionRequest $crossex_close_position_request (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexOrderActionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function closeCrossexPositionWithHttpInfo($crossex_close_position_request = null)
    {
        $request = $this->closeCrossexPositionRequest($crossex_close_position_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function closeCrossexPositionAsync($crossex_close_position_request = null)
    {
        return $this->closeCrossexPositionAsyncWithHttpInfo($crossex_close_position_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function closeCrossexPositionAsyncWithHttpInfo($crossex_close_position_request = null)
    {
        $returnType = '\GateApi\Model\CrossexOrderActionResponse';
        $request = $this->closeCrossexPositionRequest($crossex_close_position_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function closeCrossexPositionRequest($crossex_close_position_request = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($crossex_close_position_request)) {
            $_tempBody = $crossex_close_position_request;
        }
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexInterestRate[]
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexInterestRate[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCrossexInterestRateWithHttpInfo($associative_array)
    {
        ...
        $returnType = '\GateApi\Model\CrossexInterestRate[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    protected function getCrossexInterestRateRequest($associative_array)
    {
        ...
        $resourcePath = '/crossex/interest_rate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexPosition[]
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexPosition[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listCrossexPositionsWithHttpInfo($associative_array)
    {
        ...
        $returnType = '\GateApi\Model\CrossexPosition[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    protected function listCrossexPositionsRequest($associative_array)
    {
        ...
        $resourcePath = '/crossex/positions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexMarginPosition[]
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexMarginPosition[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listCrossexMarginPositionsWithHttpInfo($associative_array)
    {
        ...
        $returnType = '\GateApi\Model\CrossexMarginPosition[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    protected function listCrossexMarginPositionsRequest($associative_array)
    {
        ...
        $resourcePath = '/crossex/margin_positions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function listCrossexOpenOrdersRequest($associative_array)
    {
        ...
        $resourcePath = '/crossex/open_orders';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexHistoricalPosition[]
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexHistoricalPosition[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listCrossexHistoryPositionsWithHttpInfo($associative_array)
    {
        ...
        $returnType = '\GateApi\Model\CrossexHistoricalPosition[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    protected function listCrossexHistoryPositionsRequest($associative_array)
    {
        ...
        $resourcePath = '/crossex/history_positions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexHistoricalMarginPosition[]
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexHistoricalMarginPosition[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listCrossexHistoryMarginPositionsWithHttpInfo($associative_array)
    {
        ...
        $returnType = '\GateApi\Model\CrossexHistoricalMarginPosition[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    protected function listCrossexHistoryMarginPositionsRequest($associative_array)
    {
        ...
        $resourcePath = '/crossex/history_margin_positions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexMarginInterestRecord[]
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexMarginInterestRecord[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listCrossexHistoryMarginInterestsWithHttpInfo($associative_array)
    {
        ...
        $returnType = '\GateApi\Model\CrossexMarginInterestRecord[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    protected function listCrossexHistoryMarginInterestsRequest($associative_array)
    {
        ...
        $resourcePath = '/crossex/history_margin_interests';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexTrade[]
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexTrade[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listCrossexHistoryTradesWithHttpInfo($associative_array)
    {
        ...
        $returnType = '\GateApi\Model\CrossexTrade[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    protected function listCrossexHistoryTradesRequest($associative_array)
    {
        ...
        $resourcePath = '/crossex/history_trades';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexAccountBookRecord[]
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexAccountBookRecord[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listCrossexAccountBookWithHttpInfo($associative_array)
    {
        ...
        $returnType = '\GateApi\Model\CrossexAccountBookRecord[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    protected function listCrossexAccountBookRequest($associative_array)
    {
        ...
        $resourcePath = '/crossex/account_book';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\CrossexCoinDiscountRate[]
     */
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\CrossexCoinDiscountRate[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listCrossexCoinDiscountRateWithHttpInfo($associative_array)
    {
        ...
        $returnType = '\GateApi\Model\CrossexCoinDiscountRate[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    protected function listCrossexCoinDiscountRateRequest($associative_array)
    {
        ...
        $resourcePath = '/crossex/coin_discount_rate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
