...
class CFDApi
{
    ...
    /**
     * Operation querySymbolCommissions
     *
     * Query symbol commission rates
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $symbols List of symbol codes (multiple codes separated by commas). At least one of symbol and category_code is required (optional)
     * @param  string $category_code List of category codes (multiple codes separated by commas). When provided together with symbols, filters symbols by category. At least one of symbol and category_code is required (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\SymbolCommissions|\GateApi\Model\TradFiError
     */
    public function querySymbolCommissions($associative_array)
    {
        list($response) = $this->querySymbolCommissionsWithHttpInfo($associative_array);
        return $response;
    }

    /**
     * Operation querySymbolCommissionsWithHttpInfo
     *
     * Query symbol commission rates
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\SymbolCommissions|\GateApi\Model\TradFiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function querySymbolCommissionsWithHttpInfo($associative_array)
    {
        $request = $this->querySymbolCommissionsRequest($associative_array);
        ...
        $returnType = '\GateApi\Model\SymbolCommissions';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    /**
     * Operation querySymbolCommissionsAsync
     *
     * Query symbol commission rates
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function querySymbolCommissionsAsync($associative_array)
    {
        return $this->querySymbolCommissionsAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation querySymbolCommissionsAsyncWithHttpInfo
     *
     * Query symbol commission rates
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function querySymbolCommissionsAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\GateApi\Model\SymbolCommissions';
        $request = $this->querySymbolCommissionsRequest($associative_array);
    ...
    /**
     * Create request for operation 'querySymbolCommissions'
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $symbols List of symbol codes (multiple codes separated by commas). At least one of symbol and category_code is required (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function querySymbolCommissionsRequest($associative_array)
    {
        // unbox the parameters from the associative array
        $symbols = array_key_exists('symbols', $associative_array) ? $associative_array['symbols'] : null;
        $category_code = array_key_exists('category_code', $associative_array) ? $associative_array['category_code'] : null;


        $resourcePath = '/tradfi/symbols/commissions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function querySymbolKlineRequest($associative_array)
    {
        ...
        if ($limit !== null && $limit > 500) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling CFDApi.querySymbolKline, must be smaller than or equal to 500.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling CFDApi.querySymbolKline, must be bigger than or equal to 1.');
        }
