...
class AlphaApi
{
     ...
     *
     * @param  int $from Start timestamp for the query (required)
     * @param  int $to End timestamp for the query, defaults to current time if not specified (optional)
     * @param  int $page Page number (optional)
     * @param  int $limit Maximum 100 items per page (optional)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $currency Trading symbol (optional)
     * @param  string $side Buy or sell orders - buy - sell (optional)
     * @param  int $status Order Status - &#x60;0&#x60; : All - &#x60;1&#x60; : Processing - &#x60;2&#x60; : Successful - &#x60;3&#x60; : Failed - &#x60;4&#x60; : Cancelled - &#x60;5&#x60; : Buy order placed but transfer not completed - &#x60;6&#x60; : Order cancelled but transfer not completed (optional)
     * @param  int $from Start time for order query (optional)
     * @param  int $to End time for order query, defaults to current time if not specified (optional)
     ...
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $currency Query currency information by currency symbol (optional)
    ...
    /**
     * Operation listAlphaTokens
     *
     * Query Token Information
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $chain Query Token List by Chain  - solana - eth - bsc - base - world - sui - arbitrum - avalanche - polygon - linea - optimism - zksync - gatelayer (optional)
     * @param  string $launch_platform Query Token List by Launch Platform  - meteora_dbc - fourmeme - moonshot - pump - raydium_launchlab - letsbonk - gatefun - virtuals (optional)
     * @param  string $address Query Token List by Contract Address (optional)
     * @param  int $page Page number (optional, default to 1)
     *
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \GateApi\Model\Tokens[]
     */
    public function listAlphaTokens($associative_array)
    {
        list($response) = $this->listAlphaTokensWithHttpInfo($associative_array);
        return $response;
    }

    /**
     * Operation listAlphaTokensWithHttpInfo
     *
     * Query Token Information
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @throws \GateApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \GateApi\Model\Tokens[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listAlphaTokensWithHttpInfo($associative_array)
    {
        $request = $this->listAlphaTokensRequest($associative_array);
        ...
        $returnType = '\GateApi\Model\Tokens[]';
        $responseBody = $response->getBody();
        if ($returnType === '\SplFileObject') {
            $content = $responseBody; //stream goes to serializer
        } else {
    ...
    /**
     * Operation listAlphaTokensAsync
     *
     * Query Token Information
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAlphaTokensAsync($associative_array)
    {
        return $this->listAlphaTokensAsyncWithHttpInfo($associative_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listAlphaTokensAsyncWithHttpInfo
     *
     * Query Token Information
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAlphaTokensAsyncWithHttpInfo($associative_array)
    {
        $returnType = '\GateApi\Model\Tokens[]';
        $request = $this->listAlphaTokensRequest($associative_array);
    ...
    /**
     * Create request for operation 'listAlphaTokens'
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * @param  string $chain Query Token List by Chain  - solana - eth - bsc - base - world - sui - arbitrum - avalanche - polygon - linea - optimism - zksync - gatelayer (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listAlphaTokensRequest($associative_array)
    {
        // unbox the parameters from the associative array
        $chain = array_key_exists('chain', $associative_array) ? $associative_array['chain'] : null;
        $launch_platform = array_key_exists('launch_platform', $associative_array) ? $associative_array['launch_platform'] : null;
        $address = array_key_exists('address', $associative_array) ? $associative_array['address'] : null;
        $page = array_key_exists('page', $associative_array) ? $associative_array['page'] : 1;

        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling AlphaApi.listAlphaTokens, must be bigger than or equal to 1.');
        }


        $resourcePath = '/alpha/tokens';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($launch_platform !== null) {
            if('form' === 'form' && is_array($launch_platform)) {
                foreach($launch_platform as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['launch_platform'] = $launch_platform;
            }
        }
