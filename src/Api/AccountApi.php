...
class AccountApi
{
    ...
    {
        list($response) = $this->getAccountMainKeysWithHttpInfo();
        return $response;
    }

    /**
     * Operation getAccountMainKeysWithHttpInfo
     *
     * Query All Main Account Key Information
     *
     *
    ...
    /**
     * Operation getAccountMainKeysAsync
     *
     * Query All Main Account Key Information
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAccountMainKeysAsync()
    {
        return $this->getAccountMainKeysAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAccountMainKeysAsyncWithHttpInfo
     *
     * Query All Main Account Key Information
     *
     *
    ...
    /**
     * Create request for operation 'getAccountMainKeys'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAccountMainKeysRequest()
    {

        $resourcePath = '/account/main_keys';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
